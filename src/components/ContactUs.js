            ...
            <div className='md:col-span-2 space-y-7 lg:space-y-16'>
              <div className='space-y-7 md:flex md:justify-between md:space-y-0'>
                <div className='w-full md:w-[46%]'>
                  ...
                  <input type='text' placeholder='e.g. Abdullah' className='pt-3 pb-1 lg:mt-2 bg-black w-full border-none text-lg lg:text-xl text-white focus:outline-none' />
                  <div className='h-[2px] w-full bg-white mt-1 rounded-full'></div>
                </div>
                <div className='w-full md:w-[46%]'>
                  <label className='text-white text-lg lg:text-2xl'>Email</label><br />
                  <input type='email' placeholder='foo@example.com' className='pt-3 pb-1 lg:mt-2 bg-black w-full border-none text-lg lg:text-xl text-white focus:outline-none' />
                  <div className='h-[2px] w-full bg-white mt-1 rounded-full'></div>
                </div>
              </div>
              ...
              <div>
                ...
                <input type='text' placeholder="e.g. Hey I am interested in...." className='pt-3 pb-1 lg:mt-2 bg-black w-full border-none text-lg lg:text-xl text-white focus:outline-none' />
                <div className='h-[2px] w-full bg-white mt-1 rounded-full'></div>
              </div>
